...
def import_teams_historisch(league, year):
    """
    Importiert alle Teams in Mannschaft
    """
...
def import_goalgetters_saison(liga, saison):
    """
    Importiert Torschützen Liga/Saison
    """
...
def import_spiele_saison(liga, saison):
    """
    Importiert alle Spiele einer Liga/Saison
    """
    ...
    for spiel in spiele:
        ...
        # Ort extrahieren falls vorhanden
        ort = None
        ...
        for tor in goals:
            ...
            # Fallback: unplausibel -> überspringen
            else:
                prev_score1 = score1
                prev_score2 = score2
                continue
